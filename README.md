...
| Smart plug | `SL_OE_DE`, `ZG#TS011F` | Switch, energy, and power sensors | Switch entities are created from the reported `P1` or `O*` outputs. `ZG#TS011F` exposes energy through `EE1` when available. |
